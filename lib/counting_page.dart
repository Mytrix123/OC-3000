...
class CountingPage extends StatefulWidget {
  CountingPage({super.key, required this.imageFile});
  String imageFile;
...
class _CountingPageState extends State<CountingPage> {
  ...
  Future<void> _runInference() async {
    if (_inputImage == null || _session == null) {
      setState(() {
    ...
    try {
      ...
      // Preprocess image
      final inputTensor = await _preprocessImage(_inputImage!);
  ...
  void initState() {
    super.initState();
    _inputImage = File(widget.imageFile);
    _initModel();
  }
              ...
              if (_inputImage != null)
                Column(
                  children: [
                    ...
                    Image.file(_inputImage!, height: 200),
                  ],
                ),
              ...
              if (_outputImage != null)
                Column(
                  children: [
                    ...
                    Image.file(_outputImage!, height: 300),
